...
public class RandomTemplates {
    private static String[] names = {"Miguel", "Arthur", "Heitor", "Helena", "Alice", "Laura", "Davi", "Gabriel", "Valentina", "Maria Eduarda", "Pedro", "Matheus", "Bernardo", "Lorenzo", "Rafael", "Beatriz", "Nicolas", "Lucas", "Ana Clara", "Joaquim"};
    private static String[] lastNames = {"Silva", "Santos", "Oliveira", "Souza", "Rodrigues", "Ferreira", "Alves", "Pereira", "Lima", "Gomes", "Costa", "Ribeiro", "Martins", "Carvalho", "Araújo", "Almeida", "Melo", "Barros", "Freitas", "Vieira"};
    private static String[] emails = {"@gmail.com", "@yahoo.com", "@hotmail.com", "@outlook.com", "@icloud.com", "@uol.com.br", "@bol.com.br", "@terra.com.br", "@r7.com", "@live.com", "@gov.br", "@mail.com", "@aol.com", "@zoho.com", "@gmx.com", "@protonmail.com", "@me.com", "@msn.com", "@edu.br", "@email.com"};
    private static String[] courses = {"Administração", "Direito", "Medicina", "Engenharia Civil", "Psicologia", "Enfermagem", "Ciências Contábeis", "Pedagogia", "Arquitetura e Urbanismo", "Educação Física", "Farmácia", "Fisioterapia", "Odontologia", "Engenharia de Produção", "Ciência da Computação", "Biomedicina", "Nutrição", "Jornalismo", "Publicidade e Propaganda", "Serviço Social"};
    private static String[] schedules = {"Manhã", "Tarde", "Noite"};
